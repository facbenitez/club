...
public class TestClubMaraton {
	...
	@Test
	public void queSePuedaOrdenarPorNroDeSocioDelClub() {
		Club actual = new Club("Moron");
		...
		TreeSet<Deportista>todosLosDeportistasOrdenadosPorNroDeSocio=actual.obtenerDeportistasOrdenadosPorNroDeSocio();
		for (Deportista deportista : todosLosDeportistasOrdenadosPorNroDeSocio) {
